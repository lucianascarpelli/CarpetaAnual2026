      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-neutral-500 max-w-2xl font-light">
            Explorá cómo se combinaron diferentes herramientas para resolver
                ...
                >
                  <div className="absolute inset-0 bg-neutral-900/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 flex flex-col justify-end p-6 backdrop-blur-[2px]">
                    <motion.span
                      ...
                      className="text-emerald-400 text-sm font-bold tracking-wider uppercase mb-2 block"
                    >
                      {project.category}
                    </motion.span>
                    <motion.h3
                    ...
                    <div className="flex flex-wrap gap-2 mb-2 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-100">
                      {project.tools.map((tool) => (
                        <span
                          key={tool}
                          className="px-2 py-1 bg-white/20 text-white text-xs rounded-md backdrop-blur-md"
                        >
                          {tool}
                        </span>
                      ))}
